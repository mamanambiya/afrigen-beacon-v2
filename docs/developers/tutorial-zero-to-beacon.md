...
rather than claim coverage it cannot verify, it stops claiming.

The assembly dropdown now offers only GRCh38, so a UI user cannot reach this —
it is for API callers.
